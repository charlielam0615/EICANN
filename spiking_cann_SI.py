...
# ma_kernel = bp.nn.Conv2D(out_channels=1, kernel_size=[10000,1], padding='SAME', 
#     w_init=bp.initialize.OneInit(value=1./10000.), b_init=bp.initialize.ZeroInit())
# firing_rate = ma_kernel(runner.mon['E.spike'].astype(np.float32)) / (0.01/1000)
